  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm mt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 items-end">
        ...
        {/* Dropdowns */}
        {['Verification Status', 'Status', 'KYC Status'].map((label) => (
          <div key={label}>
          ...
          <div className="flex-1">
            ...
            <div className="relative">
              ...
              <DatePicker
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm outline-none focus:border-[#D97706] transition-colors"
