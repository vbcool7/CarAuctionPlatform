...
function AddNewStaffForm({ setCurrentPage }) {
  ...
  const [selectedReporting, setSelectedReporting] = useState("Select Reporting Manager");
          ...
          <div className='flex justify-between'>
            ...
            <div className='flex gap-2 items-center'>
              ...
              <div className='flex flex-col gap-1'>
                ...
                <span className="text-sm text-slate-500">Staff will recieve an email with login credentials and instructions</span>
              </div>
            </div>
