...
function EndedUnsoldGallery({ images = [], video = null, status = null }) {
  ...
  return (
    <>
      <div className="flex flex-col gap-3 h-full">
        ...
        <div className="relative w-full h-72 rounded-xl overflow-hidden bg-[#0F172A] group">

          {status === "unsold" && (
            <div className="absolute top-3 left-3 z-10 flex items-center gap-1 bg-[#DC2626] text-white text-[10px] font-semibold px-2 py-0.5 rounded-full uppercase">
              Not Sold
            </div>
          )}
...
export default EndedUnsoldGallery;