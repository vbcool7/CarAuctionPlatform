...
function VehicleGallery({ images = [], video = null, status = null }) {
  ...
  return (
    <>
      <div className="flex flex-col gap-3">
        ...
        {/* Main Viewer */}
        <div className="relative w-full aspect-16/10 rounded-xl overflow-hidden bg-[#0F172A] group">
          ...
          {status === "upcoming" && (
            <div className="absolute top-3 left-3 z-10 flex items-center gap-1 bg-[#DC2626] text-white text-[10px] font-semibold px-2 py-0.5 rounded-full">
              <span className="w-1.5 h-1.5 bg-white rounded-full animate-pulse uppercase" />
              Upcoming
            </div>
          )}
      ...
      {isFullscreen && (
        ...
        >
          ...
          {/* Thumbnail strip inside fullscreen */}
