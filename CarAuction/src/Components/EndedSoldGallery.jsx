...
function EndedSoldGallery({ images = [], video = null, status = null }) {
  ...
  return (
    <>
      {/* h-full so gallery stretches to match sibling panel height */}
      <div className="flex flex-col gap-3 h-full">

        {/* Main Viewer — flex-1 fills remaining height */}
        <div className="relative w-full flex-1 min-h-80 rounded-xl overflow-hidden bg-[#0F172A] group">

          {status === "sold" && (
            <div className="absolute top-3 left-3 z-10 flex items-center gap-1 bg-[#16A34A] text-white text-[10px] font-semibold px-2 py-0.5 rounded-full uppercase">
              Sold
            </div>
          )}
...
export default EndedSoldGallery;