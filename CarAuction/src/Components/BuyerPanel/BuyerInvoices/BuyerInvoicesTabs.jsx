...
const options = ['All Offers', 'Pending Review', 'Accepted', 'Countered', 'Rejected', 'Expired'];

const tabs = [
    { name: 'All Invoices', label: 'All Invoices', },
    { name: 'Paid', label: 'Paid', },
    { name: 'Unpaid', label: 'Unpaid', },
    { name: 'Refunded', label: 'Refunded', },
];

function BuyerInvoicesTabs({ activeTab, setActiveTab }) {
...
export default BuyerInvoicesTabs