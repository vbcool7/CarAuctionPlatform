...
// ===== Static option lists =====
const status = ['All Status', 'Live', 'Upcoming', 'Sold', 'UnSold'];
...
function BuyerMyBidsFilter({ variant = 'live' }) {
    return (
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm ">
            ...
            <CustomDropdown label="Status" options={status} placeholder="All Status" />
             <CustomDropdown label="Auction Type" options={auctionTypes} placeholder="All Auctions" />
...
export default BuyerMyBidsFilter;